...
- recall --atoms roundtrip test locked: enqueue->drain->FTS->source-node (T9).
- exec_utils: non-MSYS Windows routes through pwsh (PS7+) or powershell fallback.
- 1207/1207 ctest (Windows + Linux).
