...
static const char* CURRENT_VERSION = "0.32.9";   // keep synced with main.cpp / mcp/server.cpp
...
private:
    ...
    // releases pre-v0.32.9 lack .sha256 sidecar files).
    ...
    int verifyBundledDlls(const fs::path& self, const Release& r, bool skip_verify) {
        ...
        base_url = base_url.substr(0, slash + 1);  // ".../v0.32.9/"
