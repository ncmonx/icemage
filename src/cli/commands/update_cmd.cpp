...
static const char* CURRENT_VERSION = "0.31.3";   // keep synced with main.cpp / mcp/server.cpp
...
private:
    ...
    // releases pre-v0.31.3 lack .sha256 sidecar files).
    ...
    void verifyBundledDlls(const fs::path& self, const Release& r, bool skip_verify) {
        ...
        base_url = base_url.substr(0, slash + 1);  // ".../v0.31.3/"
