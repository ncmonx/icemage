...
| 21 | Advanced (embeddings, agent proxy, MCP resources, REPL, **parallel**) | [ ] | — | — | — | Plan: docs/plans/2026-05-07-phase-21-advanced.md — 6-8d. Depends on 17-20. NEW Task 5b: `icmg parallel` subprocess fan-out primitive (retrofits pack/verify/recall/scan via `--parallel` flag, 3-6× speedup on I/O-bound paths). |
