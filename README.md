...
**40 MCP tools · 1211/1211 tests · single-binary · 100 % local · pure-bash hooks** (zero Python/jq dependency).
...
| **Auto-bisect** (`icmg bisect`) | **first-bad commit in ~log2(N) tests** | — | v1.82.0 |
