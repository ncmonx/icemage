...
**40 MCP tools · 1214/1214 tests · single-binary · 100 % local · pure-bash hooks** (zero Python/jq dependency).
...
| **Auto-bisect** (`icmg bisect`) | **first-bad commit in ~log2(N) tests** | — | v1.83.0 |
